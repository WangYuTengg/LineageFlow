    ...
    <Tabs defaultValue="objects">
      <Tabs.List>
        ...
        <Tabs.Tab
          ...
          leftSection={<IconCancel style={iconStyle} />}
        >
          Uncommitted Changes
        </Tabs.Tab>
        <Tabs.Tab
          value="commits"
          leftSection={<IconGitCommit style={iconStyle} />}
        >
          Commits
        </Tabs.Tab>
        <Tabs.Tab
          value="branches"
          leftSection={<IconGitBranch style={iconStyle} />}
        >
          Branches
        </Tabs.Tab>
        <Tabs.Tab
          value="compare"
          leftSection={<IconGitCompare style={iconStyle} />}
        >
          Compare
        </Tabs.Tab>
        <Tabs.Tab
          value="actions"
          leftSection={<IconCircleCaretRight style={iconStyle} />}
        >
          Actions
        </Tabs.Tab>
        <Tabs.Tab
